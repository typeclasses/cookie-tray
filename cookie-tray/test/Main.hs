...
main = hspec do
  ...
  specify "put one" do
    shouldBe
      (render $ PutOne "userId" "917" (ExpiryAge year) (Meta scope1 security1))
  ...
  specify "put many" do
    shouldBe
      (render $ PutMany [Named "a" "1", Named "b" "2"] (ExpiryTime time1) (Meta scope1 security2))
  ...
  specify "put and delete" do
    shouldBe
      (render $ Many [Named "a" Delete, Named "b" (Put "xyz")] (ExpiryAge year) (Meta scope2 security1))
